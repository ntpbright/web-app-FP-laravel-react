              ...
              <div class="row">
                <div class="col-12 card mt-5">
                  <div class="text-center my-3">
                    <h3><i class="fas fa-plane fa-3x"></i><br/> Vacation leave</h3>
                  </div>
                  <form>
                    <div class="row">
                      <div class="col-4">
...
if (document.getElementById('VacationLeave')) {
    ReactDOM.render(<VacationLeave />, document.getElementById('VacationLeave'));
}